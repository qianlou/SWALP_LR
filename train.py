...
parser.add_argument('--dataset', type=str, default='CIFAR10',
                    help='dataset name: CIFAR10 or CIFAR100', choices=['CIFAR10', 'CIFAR100','DOGFISH'])
...
parser.add_argument('--model', type=str, default=None, required=True, metavar='MODEL',
                    ...
                    choices=['VGG16LP', 'VGG16BNLP', 'VGG19LP', 'VGG19BNLP', 'PreResNet164LP', 'PreResNet20LP','LogisticLP'])
